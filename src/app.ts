...
function sharesPriceHandlerOne(req:Request, res:Response, next:NextFunction){
     console.log(req.params);          
     next()
}

function sharesPriceHandlerTwo(req:Request, res:Response, next:NextFunction){
     console.log("second handler")             
     return res.send(req.params)
}

app.get('/api/shareId/:nseValue/:bseValue', function (req: Request, res: Response, next: NextFunction) {
     next()
 },
